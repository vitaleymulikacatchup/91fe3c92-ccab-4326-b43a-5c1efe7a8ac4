    ...
    <SiteThemeProvider theme={{ styleVariant: 'funAndTrendy', colorTemplate: 1, textAnimation: 'slide' }}>
      ...
      <div id="tokenomics" data-section="tokenomics" className="scroll-mt-24">
        <BigNumberTokenomics
          ...
          kpiItems={[
            { value: '5M', description: 'Total Supply', longDescription: 'The complete supply of MemeCoin is 5 million.', icon: 'LucideIcon' },
            { value: '2M', description: 'Circulating Supply', longDescription: 'Currently circulating 2 million MemeCoins.', icon: 'LucideIcon' },
            { value: '1M', description: 'Market Cap', longDescription: 'The market cap is at 1 million USD.', icon: 'LucideIcon' }
          ]}
        />
      </div>
